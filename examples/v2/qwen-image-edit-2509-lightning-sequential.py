...
prompt = (
    "Let the man in image 1 lie on the sofa in image 3, "
    "and let the puppy in image 2 lie on the floor to sleep."
)
...
while time.time() - start_time < duration_seconds:
    ...
    image_out.save(
        f"qwen-image-edit-2509-lightning-r{rank}-{num_inference_steps}steps_{timestamp}_{execution_count}.png"
    )
    execution_count += 1
